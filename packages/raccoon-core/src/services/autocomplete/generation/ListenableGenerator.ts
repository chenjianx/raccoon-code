/**
 * Buffers an async generator and lets multiple consumers tee() off it, so a
 * pending completion request can be reused as the user keeps typing. Ported
 * verbatim from continue-rac (core/autocomplete/generation/ListenableGenerator.ts).
 */
